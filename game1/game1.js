...
function preload() {
  ...
  bg4 = loadImage('https://artofclc.github.io/game1/tree.jpg');
  mask = loadImage('https://artofclc.github.io/game1/mask.png');
...
function levelFour() {
  ...
  text("Level 4", width / 2, height - height / 20);
  var distToBall = dist(ballx, bally, mouseX, mouseY);
  if (distToBall < ballSize / 2) {
    ballx = random(width);
    bally = random(height);
  ...
  image(mask, ballx - ballSize * 1.5, bally - ballSize * 1.5, ballSize * 3, ballSize * 3);
}

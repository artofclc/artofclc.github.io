      ...
      img5= loadImage('https://artofclc.github.io/burger/chez.png');
       img6= loadImage('https://artofclc.github.io/burger/lettuce.png');
        ...
        img10= loadImage('https://artofclc.github.io/burger/ketchup.png');
         img11= loadImage('https://artofclc.github.io/burger/mustard.png');
}
...
function newkeyChoice(toolChoice) { //toolchoice is the key that was pressed
 ...
 if (toolChoice == '1' ) {  // first tool
    ...
    image(img2, mouseX-150, mouseY-50);
    
  } else if (toolChoice == '2') { // second tool

   image(img3, mouseX-160, mouseY-50, 340, 80);
    
  } else if (toolChoice == '3') { // third tool

    image(img4, mouseX-190, mouseY-50, 400,100);
  } else if (toolChoice == '4') {

 image(img5, mouseX-190, mouseY-50, 400,100);
  } else if (toolChoice == '5') {
    
 image(img6, mouseX-190, mouseY-170, 370,280);
  } else if (toolChoice == '6') {
image(img7, mouseX-100, mouseY-30, 200,70);
   
  } else if (toolChoice == '7') {
image(img8, mouseX-140, mouseY-30, 300,100);
   
   
  } else if (toolChoice == '8') {
image(img9, mouseX-160, mouseY-90, 300,180);


  } else if (toolChoice == '9') {

    image(img10, mouseX-15, mouseY-5, 30,15)
  } else if (toolChoice == '0') {
   image(img11, mouseX-30, mouseY-25, 70,50)

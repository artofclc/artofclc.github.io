...
// Add the following event listeners for Apple Pencil input
document.querySelector('#hueJitter').addEventListener('pointerdown', function (event) {
  if (event.pointerType === 'pen') {
    event.target.setPointerCapture(event.pointerId);
  }
});
document.querySelector('#hueJitter').addEventListener('pointermove', function (event) {
  if (event.pointerType === 'pen') {
    event.preventDefault();
    hueJitterRange = parseInt(event.target.value, 10);
  }
});
document.querySelector('#hueJitter').addEventListener('pointerup', function (event) {
  if (event.pointerType === 'pen') {
...
// Add the following event listener for Apple Pencil input
document.querySelector('#toolSelector').addEventListener('pointerdown', function (event) {
  if (event.pointerType === 'pen') { // Check if the input is from an Apple Pencil
    event.target.focus();
  }
});
  ...
  document.querySelector('#undoButton').addEventListener('touchstart', function (event) {
    event.preventDefault();
    undo();
    updateButtonStates();
  });
  ...
  document.querySelector('#redoButton').addEventListener('touchstart', function (event) {
    event.preventDefault();
    redo();
    updateButtonStates();
  });
  ...
  document.querySelector('#clearButton').addEventListener('touchstart', function (event) {
    event.preventDefault();
    background(screenbg);
    saveState();
    updateButtonStates();
  ...
  document.querySelector('#saveButton').addEventListener('touchstart', function (event) {
    event.preventDefault();
    saveState();
    saveme();
  });
...
// Add the following event listener for Apple Pencil input
document.querySelector('#colorPicker').addEventListener('pointerdown', function (event) {
  if (event.pointerType === 'pen') { // Check if the input is from an Apple Pencil
    event.target.focus();
  }
});;
...
// Add the following event listeners for Apple Pencil input
document.querySelector('#brushSize').addEventListener('pointerdown', function (event) {
  if (event.pointerType === 'pen') {
    event.target.setPointerCapture(event.pointerId);
  }
});
document.querySelector('#brushSize').addEventListener('pointermove', function (event) {
  if (event.pointerType === 'pen') {
    event.preventDefault();
    currentSize = parseInt(event.target.value, 10);
  }
});
document.querySelector('#brushSize').addEventListener('pointerup', function (event) {
  if (event.pointerType === 'pen') {
    event.target.releasePointerCapture(event.pointerId);
  }
});
...
// Add the following event listeners for Apple Pencil input
document.querySelector('#opacitySlider').addEventListener('pointerdown', function (event) {
  if (event.pointerType === 'pen') {
    event.target.setPointerCapture(event.pointerId);
  }
});
document.querySelector('#opacitySlider').addEventListener('pointermove', function (event) {
  if (event.pointerType === 'pen') {
    event.preventDefault();
    currentOpacity = parseInt(event.target.value, 10);
  }
});
document.querySelector('#opacitySlider').addEventListener('pointerup', function (event) {
  if (event.pointerType === 'pen') {
    event.target.releasePointerCapture(event.pointerId);
  }
});
  ...
  document.getElementById('eraserButton').addEventListener('touchstart', function (event) {
    event.preventDefault();
    const eraserButton = document.getElementById('eraserButton');
...
function draw() {
if ((mouseIsPressed || touchOnCanvas) && inputMoved && isMouseInsideCanvas()) {
